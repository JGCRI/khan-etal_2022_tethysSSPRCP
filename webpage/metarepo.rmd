...
<<<<<<< HEAD:vignettes/vignette_metarepo.Rmd
...
>>>>>>> 388a650689c6580c6f1f36950e3b75fcf005ccf8:webpage/metarepo.rmd
```
...
knitr::include_graphics("vignetteFigs/overview_map.png")
```

## Indus
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("vignetteFigs/WITHOUTBIOMASS.png")
```
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("vignetteFigs/heatmap.png")
```
## Nile
Placeholder Text
