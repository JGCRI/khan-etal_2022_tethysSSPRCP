...
GCAM irrigation withdrawal and consumption outputs are organized into 13 crop types: 

Spatial landcover outputs from Demeter are reaggregated to the target resolution of 0.5 degrees. These cover 12 of the crop types. For each region-basin intersection, and each crop type (except for biomass), the water withdrawal from GCAM is allocated to the constituent grids in proportion to the ratio from Demeter. Biomass is distributed uniformly.
