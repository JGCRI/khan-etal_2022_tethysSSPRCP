...
output: 
  html_document:
    ...
    #inverse: true
---
<!-- Allow linking to tabset images --> 
```{js, echo=FALSE}
...
for(sector in c("total", "dom", "elec", "mfg", "min", "liv", "irr")){
  ...
  cat("\n#####", "ssp1_rcp26_gfdl", "\n")
  cat("![](images/Indus_", sector, ".png)", sep="")
  cat('\n')
  cat("![](images/heatmap_Indus_", sector, ".png)", sep="")
  cat('\n')
}
```
...
for(sector in c("Corn", "FiberCrop", "MiscCrop", "OilCrop", "OtherGrain", "Rice", "Root_Tuber", "SugarCrop", "Wheat")){
  cat("\n####", sector, "{.tabset .tabset-pills}\n")
  cat("\n#####", "ssp1_rcp26_gfdl", "\n")
  cat("![](images/Indus_", sector, ".png)\n", sep="")
  cat("![](images/heatmap_Indus_", sector, ".png)\n", sep="")
}
```
