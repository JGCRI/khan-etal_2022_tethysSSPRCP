...
knitr::include_graphics("images/Indus_total.png")
```
#### Domestic
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_dom.png")
```
#### Electric
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_elec.png")
```
#### Manufacturing
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_mfg.png")
```
#### Mining
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_min.png")
```
#### Livestock
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_liv.png")
```
#### Irrigation
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Figure"}
knitr::include_graphics("images/Indus_irr.png")
```
